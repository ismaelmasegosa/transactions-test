...
import com.ismaelmasegosa.transaction.challenge.domain.transaction.status.rules.ClientChannelOrAtmAndDateBeforeToday;
...
public class TransactionsStatusProvider {
  ...
  public TransactionStatus getTransactionStatus(Transaction transaction, String channel) {
    ...
    criterias.add(new ClientChannelOrAtmAndDateBeforeToday(transaction, channel));
