...
public class SearchTransactionsController {
  ...
  public ResponseEntity<List<TransactionResponse>> findTransactionByIbanOrderByAmount(@PathVariable(name = "iban") String iban,
  ...
  private SearchTransactionsParams toParams(String iban, int sort) {
